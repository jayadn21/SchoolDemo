(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["STUDENTS-admission-enquiry-admission-enquiry-module~STUDENTS-custom-fields-custom-fields-module"],{
...
var CustomFieldsService = /** @class */ (function () {
    ...
    function CustomFieldsService(ServiceUitility) {
        this.ServiceUitility = ServiceUitility;
        this.route = '/CustomField';
        this._getCustomFields = this.route + '/getCustomFields';
        this._getCustomField = this.route + '/getCustomField';
        this._setCustomField = this.route + '/setCustomField';
    }
    CustomFieldsService.prototype.getCustomFields = function () {
        return this.ServiceUitility.postRequest(this._getCustomFields, '');
    };
    CustomFieldsService.prototype.getCustomField = function () {
        return this.ServiceUitility.postRequest(this._getCustomField, '');
    };
    CustomFieldsService.prototype.setCustomField = function (obj) {
...
//# sourceMappingURL=STUDENTS-admission-enquiry-admission-enquiry-module~STUDENTS-custom-fields-custom-fields-module.js.map